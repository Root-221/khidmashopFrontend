...
type RawCountry = Pick<CountryIndicator, 'code' | 'dial'>;
...
const countries: CountryIndicator[] = rawCountries
  .map((entry) => ({
    ...entry,
    label: countryNameFormatter.of(entry.code) ?? entry.code,
    flag: toFlagEmoji(entry.code),
  }))
